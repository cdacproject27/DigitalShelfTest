...
public partial class BookwormfinalBackupContext : DbContext
{
    public BookwormfinalBackupContext()
    {
    }

    public BookwormfinalBackupContext(DbContextOptions<BookwormfinalBackupContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;port=3306;user=root;password=Karuna;database=bookwormfinal_backup", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.2.0-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<LibraryPackagePurchase>(entity =>
        {
            ...
            entity.HasIndex(e => e.PackageId, "idx_lpp_package");

            entity.HasIndex(e => e.TransactionId, "idx_lpp_transaction");

            entity.HasIndex(e => e.UserId, "idx_lpp_user");

            entity.Property(e => e.PurchaseId).HasColumnName("purchase_id");
            entity.Property(e => e.AllowedBooks).HasColumnName("allowed_books");
            ...
            entity.HasOne(d => d.Package).WithMany(p => p.LibraryPackagePurchases)
                .HasForeignKey(d => d.PackageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_lpp_package");

            entity.HasOne(d => d.Transaction).WithMany(p => p.LibraryPackagePurchases)
                .HasForeignKey(d => d.TransactionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_lpp_transaction");

            entity.HasOne(d => d.User).WithMany(p => p.LibraryPackagePurchases)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<LibraryPackagePurchaseItem>(entity =>
        {
            ...
            entity.HasIndex(e => e.ProductId, "idx_lppi_product");

            entity.HasIndex(e => e.PurchaseId, "idx_lppi_purchase");
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.LibraryPackagePurchaseItems)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_lppi_product");

            entity.HasOne(d => d.Purchase).WithMany(p => p.LibraryPackagePurchaseItems)
